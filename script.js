const flags = [
    ...
    { emoji: '🇦🇸', name: 'American Samoa', colors: ['red', 'white', 'blue'], region: 'Oceania' },
    { emoji: '🇦🇴', name: 'Angola', colors: ['red', 'black', 'yellow'], region: 'Africa' },
    { emoji: '🇦🇩', name: 'Andorra', colors: ['blue', 'yellow', 'red'], region: 'Europe' },
    { emoji: '🇦🇮', name: 'Anguilla', colors: ['blue', 'white', 'red'], region: 'North America' },
    { emoji: '🇦🇶', name: 'Antarctica', colors: ['blue', 'white'], region: 'Antarctica' },
    { emoji: '🇦🇬', name: 'Antigua & Barbuda', colors: ['black', 'red', 'blue', 'yellow', 'white'], region: 'North America' },
    { emoji: '🇦🇷', name: 'Argentina', colors: ['blue', 'white', 'yellow'], region: 'South America' },
    { emoji: '🇦🇲', name: 'Armenia', colors: ['red', 'blue', 'orange'], region: 'Asia' },
    { emoji: '🇦🇼', name: 'Aruba', colors: ['blue', 'yellow', 'red'], region: 'North America' },
    { emoji: '🇦🇽', name: 'Åland Islands', colors: ['blue', 'yellow', 'red'], region: 'Europe' },
    { emoji: '🇦🇨', name: 'Ascension Island', colors: ['blue', 'yellow', 'green'], region: 'Africa' },
    ...
    { emoji: '🇧🇲', name: 'Bermuda', colors: ['red', 'white', 'blue'], region: 'North America' },
    ...
    { emoji: '🇧🇻', name: 'Bouvet Island', colors: ['red', 'white', 'blue'], region: 'Antarctica' },
    { emoji: '🇧🇷', name: 'Brazil', colors: ['green', 'yellow', 'blue', 'white'], region: 'South America' },
    { emoji: '🇮🇴', name: 'British Indian Ocean Territory', colors: ['blue', 'white', 'green', 'red', 'yellow'], region: 'Asia' },
    ...
    { emoji: '🇮🇨', name: 'Canary Islands', colors: ['blue', 'white', 'yellow'], region: 'Europe' },
    { emoji: '🇰🇾', name: 'Cayman Islands', colors: ['blue', 'white', 'red'], region: 'North America' },
    { emoji: '🇧🇶', name: 'Caribbean Netherlands', colors: ['blue', 'yellow', 'red', 'white'], region: 'North America' },
    ...
    { emoji: '🇨🇽', name: 'Christmas Island', colors: ['blue', 'green', 'yellow'], region: 'Asia' },
    { emoji: '🇨🇨', name: 'Cocos (Keeling) Islands', colors: ['green', 'yellow'], region: 'Asia' },
    ...
    { emoji: '🇨🇰', name: 'Cook Islands', colors: ['blue', 'white'], region: 'Oceania' },
    { emoji: '🇨🇷', name: 'Costa Rica', colors: ['blue', 'white', 'red'], region: 'North America' },
    { emoji: '🇨🇮', name: 'Côte d’Ivoire', colors: ['orange', 'white', 'green'], region: 'Africa' },
    { emoji: '🇨🇵', name: 'Clipperton Island', colors: ['blue', 'yellow'], region: 'North America' },
    { emoji: '🇭🇷', name: 'Croatia', colors: ['red', 'white', 'blue'], region: 'Europe' },
    { emoji: '🇨🇺', name: 'Cuba', colors: ['blue', 'white', 'red'], region: 'North America' },
    { emoji: '🇨🇼', name: 'Curaçao', colors: ['blue', 'yellow', 'white'], region: 'North America' },
    ...
    { emoji: '🇩🇬', name: 'Diego Garcia', colors: ['blue', 'white', 'green', 'yellow', 'red'], region: 'Asia' },
    ...
    { emoji: '🇪🇺', name: 'European Union', colors: ['blue', 'yellow'], region: 'Europe' },
    { emoji: '🇫🇰', name: 'Falkland Islands', colors: ['blue', 'white', 'red'], region: 'South America' },
    { emoji: '🇫🇴', name: 'Faroe Islands', colors: ['blue', 'white', 'red'], region: 'Europe' },
    ...
    { emoji: '🇬🇫', name: 'French Guiana', colors: ['green', 'yellow', 'red'], region: 'South America' },
    { emoji: '🇵🇫', name: 'French Polynesia', colors: ['red', 'white', 'yellow'], region: 'Oceania' },
    ...
    { emoji: '🇬🇮', name: 'Gibraltar', colors: ['red', 'white'], region: 'Europe' },
    { emoji: '🇬🇭', name: 'Ghana', colors: ['red', 'yellow', 'green', 'black'], region: 'Africa' },
    { emoji: '🇬🇷', name: 'Greece', colors: ['blue', 'white'], region: 'Europe' },
    { emoji: '🇬🇱', name: 'Greenland', colors: ['red', 'white'], region: 'North America' },
    { emoji: '🇬🇩', name: 'Grenada', colors: ['red', 'yellow', 'green'], region: 'North America' },
    { emoji: '🇬🇵', name: 'Guadeloupe', colors: ['green', 'yellow', 'red'], region: 'North America' },
    { emoji: '🇬🇺', name: 'Guam', colors: ['blue', 'yellow', 'red'], region: 'Oceania' },
    { emoji: '🇬🇹', name: 'Guatemala', colors: ['blue', 'white'], region: 'North America' },
    { emoji: '🇬🇬', name: 'Guernsey', colors: ['red', 'white', 'yellow'], region: 'Europe' },
    ...
    { emoji: '🇭🇲', name: 'Heard & McDonald Islands', colors: ['blue', 'white', 'red'], region: 'Antarctica' },
    { emoji: '🇭🇳', name: 'Honduras', colors: ['blue', 'white'], region: 'North America' },
    { emoji: '🇭🇰', name: 'Hong Kong SAR China', colors: ['red', 'white'], region: 'Asia' },
    ...
    { emoji: '🇮🇲', name: 'Isle of Man', colors: ['red', 'white', 'yellow'], region: 'Europe' },
    ...
    { emoji: '🇯🇪', name: 'Jersey', colors: ['red', 'white'], region: 'Europe' },
    ...
    { emoji: '🇲🇶', name: 'Martinique', colors: ['blue', 'white'], region: 'North America' },
    ...
    { emoji: '🇲🇸', name: 'Montserrat', colors: ['blue', 'white', 'green', 'yellow'], region: 'North America' },
    ...
    { emoji: '🇳🇨', name: 'New Caledonia', colors: ['blue', 'white', 'red', 'yellow'], region: 'Oceania' },
    { emoji: '🇳🇿', name: 'New Zealand', colors: ['blue', 'red', 'white'], region: 'Oceania' },
    { emoji: '🇲🇵', name: 'Northern Mariana Islands', colors: ['blue', 'white'], region: 'Oceania' },
    ...
    { emoji: '🇳🇺', name: 'Niue', colors: ['yellow', 'blue', 'red', 'white'], region: 'Oceania' },
    { emoji: '🇰🇵', name: 'North Korea', colors: ['red', 'white', 'blue'], region: 'Asia' },
    { emoji: '🇲🇰', name: 'North Macedonia', colors: ['red', 'yellow'], region: 'Europe' },
    { emoji: '🇳🇫', name: 'Norfolk Island', colors: ['green', 'white'], region: 'Oceania' },
    ...
    { emoji: '🇵🇳', name: 'Pitcairn Islands', colors: ['blue', 'white', 'green', 'yellow', 'red'], region: 'Oceania' },
    { emoji: '🇵🇱', name: 'Poland', colors: ['red', 'white'], region: 'Europe' },
    { emoji: '🇵🇹', name: 'Portugal', colors: ['green', 'red'], region: 'Europe' },
    { emoji: '🇵🇷', name: 'Puerto Rico', colors: ['blue', 'white', 'red'], region: 'North America' },
    ...
    { emoji: '🇧🇱', name: 'Saint Barthélemy', colors: ['blue', 'yellow', 'white', 'red'], region: 'North America' },
    ...
    { emoji: '🇬🇸', name: 'South Georgia & South Sandwich Islands', colors: ['blue', 'white', 'red'], region: 'Antarctica' },
    ...
    { emoji: '🇸🇭', name: 'St. Helena', colors: ['blue', 'white', 'yellow', 'green'], region: 'Africa' },
    { emoji: '🇵🇲', name: 'St. Pierre & Miquelon', colors: ['blue', 'white', 'red', 'yellow'], region: 'North America' },
    ...
    { emoji: '🇪🇭', name: 'Western Sahara', colors: ['red', 'white', 'black', 'green'], region: 'Africa' },
